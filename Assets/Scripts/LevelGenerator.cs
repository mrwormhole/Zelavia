...
public class LevelGenerator : MonoBehaviour {
    ...
    protected void createTilesForBoard(int row,int column)
    {
        int p = 0; //this will be equal to total tile count
    ...
    {
        int q = 0; //this will be equal to total indicator count
   ...
   protected IEnumerator goForNextLevel()
    {
    ...
    {
        // this algorithm can be optimized for better memory. all Unlock values doesn't make sense. We know the indicators count. If all true then we go for endForCurrentLevel
        ...
        {
            //0 to indicators Count should be enough
