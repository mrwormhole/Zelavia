...
public class LevelGenerator : MonoBehaviour {
    ...
    public delegate void FadeAnimator(string option);
    public static event FadeAnimator fadeAnimator; //getting subscribed by MenuManager.Perfecly fine
